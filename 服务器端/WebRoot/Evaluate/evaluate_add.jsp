	...
	<form id="evaluateAddForm" enctype="multipart/form-data"  method="post">
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="evaluate_sellerObj_sellerUserName" name="evaluate.sellerObj.sellerUserName" style="width: auto"/>
			</span>
		</div>
		<div>
			<span class="label">评分:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="evaluate_evaluateScore" name="evaluate.evaluateScore" style="width:80px" />
		...
		<div>
			...
			<span class="inputControl">
				<textarea id="evaluate_evaluateContent" name="evaluate.evaluateContent" rows="6" cols="80"></textarea>
