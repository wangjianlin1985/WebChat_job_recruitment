...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Evaluate/frontlist">商家评价信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">评价id:</div>
		<div class="col-md-10 col-xs-6"><%=evaluate.getEvaluateId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">被评价商家:</div>
		<div class="col-md-10 col-xs-6"><%=evaluate.getSellerObj().getSellerName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">评分:</div>
		<div class="col-md-10 col-xs-6"><%=evaluate.getEvaluateScore()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">评价内容:</div>
		<div class="col-md-10 col-xs-6"><%=evaluate.getEvaluateContent()%></div>
	</div>
	<div class="row bottom15"> 
