...
<%
    ...
    String replyPerson = (String)request.getAttribute("replyPerson"); //回复人查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#leavewordListPanel" aria-controls="leavewordListPanel" role="tab" data-toggle="tab">客服留言列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Leaveword/leaveword_frontAdd.jsp" style="display:none;">添加客服留言</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>留言id</td><td>留言标题</td><td>留言人</td><td>留言时间</td><td>回复内容</td><td>回复人</td><td>回复时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<leavewordList.size();i++) {
					    	            		...
					    	            		Leaveword leaveword = leavewordList.get(i); //获取到客服留言对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											...
 											<td><%=leaveword.getReplyPerson() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="leavewordQueryForm" id="leavewordQueryForm" action="<%=basePath %>Leaveword/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="replyPerson">回复人:</label>
				<input type="text" id="replyPerson" name="replyPerson" value="<%=replyPerson %>" class="form-control" placeholder="请输入回复人">
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;客服留言信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="leaveword_replyPerson_edit" class="col-md-3 text-right">回复人:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="leaveword_replyPerson_edit" name="leaveword.replyPerson" class="form-control" placeholder="请输入回复人">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (leaveword, response, status) {
			if (leaveword) {
				...
				$("#leaveword_replyPerson_edit").val(leaveword.replyPerson);
