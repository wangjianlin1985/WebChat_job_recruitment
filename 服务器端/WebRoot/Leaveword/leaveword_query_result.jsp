...
<div id="leaveword_manage_tool" style="padding:5px;">
	<div style="margin-bottom:5px;">
		<a href="#" class="easyui-linkbutton" iconCls="icon-edit-new" plain="true" onclick="leaveword_manage_tool.edit();">回复</a>
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="leavewordQueryForm" method="post">
			...
			回复人：<input type="text" class="textbox" id="replyPerson" name="replyPerson" style="width:110px" />
...
<div id="leavewordEditDiv">
	<form id="leavewordEditForm" enctype="multipart/form-data"  method="post">
		...
		<div style="display:none;">
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="leaveword_replyPerson_edit" name="leaveword.replyPerson" style="width:200px" />
