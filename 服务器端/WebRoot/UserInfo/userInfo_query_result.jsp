...
<div id="userInfoEditDiv">
	<form id="userInfoEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			<span class="label">院系班级:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_yxbj_edit" name="userInfo.yxbj" style="width:200px" />
		...
		<div>
			<span class="label">个人简历:</span>
			<span class="inputControl">
				<textarea id="userInfo_grjl_edit" name="userInfo.grjl" rows="8" cols="60"></textarea>
