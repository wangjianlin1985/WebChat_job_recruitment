...
<div id="userInfoAddDiv">
	<form id="userInfoAddForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_yxbj" name="userInfo.yxbj" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<textarea id="userInfo_grjl" name="userInfo.grjl" rows="6" cols="80"></textarea>
