  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_password_edit" class="col-md-3 text-right">预留密码段:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_password_edit" name="userInfo.password" class="form-control" placeholder="请输入预留密码段">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="userInfo_yxbj_edit" class="col-md-3 text-right">院系班级:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_yxbj_edit" name="userInfo.yxbj" class="form-control" placeholder="请输入院系班级">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_grjl_edit" class="col-md-3 text-right">个人简历:</label>
		  	 <div class="col-md-9">
			    <textarea id="userInfo_grjl_edit" name="userInfo.grjl" rows="8" class="form-control" placeholder="请输入个人简历"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_yxbj_edit").val(userInfo.yxbj);
				...
				$("#userInfo_grjl_edit").val(userInfo.grjl);
