...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">院系班级:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getYxbj()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">个人简历:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getGrjl()%></div>
	</div>
	<div class="row bottom15"> 
