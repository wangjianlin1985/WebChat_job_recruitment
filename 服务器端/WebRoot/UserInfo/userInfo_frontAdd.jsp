	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_password" class="col-md-2 text-right">预留密码段:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_password" name="userInfo.password" class="form-control" placeholder="请输入预留密码段">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="userInfo_yxbj" class="col-md-2 text-right">院系班级:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_yxbj" name="userInfo.yxbj" class="form-control" placeholder="请输入院系班级">
					 </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_grjl" class="col-md-2 text-right">个人简历:</label>
				  	 <div class="col-md-8">
					    <textarea id="userInfo_grjl" name="userInfo.grjl" rows="8" class="form-control" placeholder="请输入个人简历"></textarea>
					 </div>
				  </div>
				  <div class="form-group">
