...
public class DeliveryService {
    ...
    /*按照查询条件分页查询简历投递记录*/
    public ArrayList<Delivery> queryDelivery(Job jobObj,UserInfo userObj,String deliveryTime,String handleState,int currentPage) throws Exception { 
    	...
    	if(!handleState.equals("")) where = where + " and t_delivery.handleState like '%" + handleState + "%'";
    	int startIndex = (currentPage-1) * this.rows;
    	return deliveryMapper.queryDelivery(where, startIndex, this.rows);
    }
    
    /*按照查询条件分页查询简历投递记录*/
    public ArrayList<Delivery> sellerQueryDelivery(Job jobObj,String sellerUserName,UserInfo userObj,String deliveryTime,String handleState,int currentPage) throws Exception { 
     	String where = "where 1=1 and t_job.sellerObj='" + sellerUserName + "' ";
    	if(null != jobObj && jobObj.getJobId()!= null && jobObj.getJobId()!= 0)  where += " and t_delivery.jobObj=" + jobObj.getJobId();
    	if(null != userObj &&  userObj.getUser_name() != null  && !userObj.getUser_name().equals(""))  where += " and t_delivery.userObj='" + userObj.getUser_name() + "'";
    	if(!deliveryTime.equals("")) where = where + " and t_delivery.deliveryTime like '%" + deliveryTime + "%'";
    	if(!handleState.equals("")) where = where + " and t_delivery.handleState like '%" + handleState + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Delivery> queryDelivery(Job jobObj,UserInfo userObj,String deliveryTime,String handleState) throws Exception  { 
     	String where = "where 1=1";
    	if(null != jobObj && jobObj.getJobId()!= null && jobObj.getJobId()!= 0)  where += " and t_delivery.jobObj=" + jobObj.getJobId();
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_delivery.userObj='" + userObj.getUser_name() + "'";
    	if(!deliveryTime.equals("")) where = where + " and t_delivery.deliveryTime like '%" + deliveryTime + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(Job jobObj,UserInfo userObj,String deliveryTime,String handleState) throws Exception {
     	String where = "where 1=1";
    	if(null != jobObj && jobObj.getJobId()!= null && jobObj.getJobId()!= 0)  where += " and t_delivery.jobObj=" + jobObj.getJobId();
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_delivery.userObj='" + userObj.getUser_name() + "'";
    	if(!deliveryTime.equals("")) where = where + " and t_delivery.deliveryTime like '%" + deliveryTime + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void sellerQueryTotalPageAndRecordNumber(Job jobObj,String sellerUserName,UserInfo userObj,String deliveryTime,String handleState) throws Exception {
    	String where = "where 1=1 and t_job.sellerObj='" + sellerUserName + "' ";
    	if(null != jobObj && jobObj.getJobId()!= null && jobObj.getJobId()!= 0)  where += " and t_delivery.jobObj=" + jobObj.getJobId();
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_delivery.userObj='" + userObj.getUser_name() + "'";
    	if(!deliveryTime.equals("")) where = where + " and t_delivery.deliveryTime like '%" + deliveryTime + "%'";
