...
public class EvaluateService {
    ...
    /*按照查询条件分页查询商家评价记录*/
    public ArrayList<Evaluate> queryEvaluate(Seller sellerObj,String evaluateContent,UserInfo userObj,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(null != sellerObj &&  sellerObj.getSellerUserName() != null  && !sellerObj.getSellerUserName().equals(""))  where += " and t_evaluate.sellerObj='" + sellerObj.getSellerUserName() + "'";
    	if(!evaluateContent.equals("")) where = where + " and t_evaluate.evaluateContent like '%" + evaluateContent + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Evaluate> queryEvaluate(Seller sellerObj,String evaluateContent,UserInfo userObj) throws Exception  { 
     	String where = "where 1=1";
    	if(null != sellerObj &&  sellerObj.getSellerUserName() != null && !sellerObj.getSellerUserName().equals(""))  where += " and t_evaluate.sellerObj='" + sellerObj.getSellerUserName() + "'";
    	if(!evaluateContent.equals("")) where = where + " and t_evaluate.evaluateContent like '%" + evaluateContent + "%'";
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_evaluate.userObj='" + userObj.getUser_name() + "'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(Seller sellerObj,String evaluateContent,UserInfo userObj) throws Exception {
     	String where = "where 1=1";
    	if(null != sellerObj &&  sellerObj.getSellerUserName() != null && !sellerObj.getSellerUserName().equals(""))  where += " and t_evaluate.sellerObj='" + sellerObj.getSellerUserName() + "'";
    	if(!evaluateContent.equals("")) where = where + " and t_evaluate.evaluateContent like '%" + evaluateContent + "%'";
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_evaluate.userObj='" + userObj.getUser_name() + "'";
