...
public class ApiLeavewordController {
	...
	public JsonResult add(Leaveword leaveword, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		//通过accessToken获取到用户信息 
		String userName = authService.getUserName(request);
		if(userName == null) return JsonResultBuilder.error(ReturnCode.TOKEN_VALID_ERROR);
	...
	public JsonResult list(String leaveTitle,@ModelAttribute("userObj") UserInfo userObj,String leaveTime,String replyPerson,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
	...
	public JsonResult userList(String leaveTitle,@ModelAttribute("userObj") UserInfo userObj,String leaveTime,String replyPerson,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		//通过accessToken获取到用户信息 
		String userName = authService.getUserName(request);
		if(userName == null) return JsonResultBuilder.error(ReturnCode.TOKEN_VALID_ERROR);
